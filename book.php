...
<section class="booking">
   ...
   <h1 class="heading-title">Yuk Liburan</h1>
   ...
   <form action="book_form.php" method="post" class="book-form">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>nama :</span>
            <input type="text" placeholder="silahkan isi nama anda" name="name">
         </div>
         <div class="inputBox">
            <span>mau kemana  :</span>
            <input type="text" placeholder="masukkan tempat liburan" name="location">
         </div>
         <div class="inputBox">
            <span>kapan berangkatnya  :</span>
            <input type="date" placeholder="" name="date">
         </div>
         <div class="inputBox">
            <span>Naik apa  :</span>
            <input type="text"placeholder="masukkan jenis kendaraan" name="vehicle">
         </div>
         <div class="inputBox">
            <span>Tempat Asal :</span>
            <input type="text" placeholder="masukkan tempat asal" name="from">
         </div>
      </div>
